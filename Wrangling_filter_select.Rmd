...
i belive the second code is wrong because its not in order
...
movies%>%
  arrange(year)
```
after running the code, i found out that the longest movie was the cure for insomnia(5220 minutes) and the oldest movie was the blacksmith scene(1893) 
...
After running the above code I foound out that there is 4 movies under those categories.
...
After running the code above I found out that the movie with the highest budget for an animetion or comedy with at least 100 votes was Wild West with a budget of $170000000	
